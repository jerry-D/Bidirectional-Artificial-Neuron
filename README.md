...
(June 7, 2025)  United States Patent No. US12,324,295B, entitled "COMPLEX NANOSTRUCTURE FORMING A BIDIRECTIONAL NANOSTRUCTURE  MULTIPLEXER OR ARTIFICIAL NEURON" issued on June 3, 2025.  It is the world's first bidirectional artificial neuron "free energy" device for conscious machines.  The artificial neuron is built from carbon nanotubes, carbon nanotorus, and a segment of human ssDNA.  The now patented invention is the first in a series of several fundamental building blocks at the nano scale for use in future conscious machines. Here is the link where you can download a copy from this repository:
